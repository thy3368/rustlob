...
use derivatives_behavior::proc::usds_m_future::behavior::trade_behavior::{
    UsdsMFutureTradeBehavior, UsdsMFutureTradeCmdOrQuery, UsdsMFutureTradeRes,
};
use derivatives_behavior::proc::usds_m_future::usds_trade::UsdsMFutureTradeBehaviorImpl;
use serde::{Deserialize, Serialize};
use spot_behavior::proc::behavior::v2::spot_trade_error::CmdResp;
...
impl TradeService {
    ...
    ) -> Result<CmdResp<UsdsMFutureTradeRes>, String> {
...
pub async fn handle(
    ...
    Json(cmd): Json<UsdsMFutureTradeCmdOrQuery>,
) -> impl IntoResponse {
    println!("📋 收到USDS-M期货交易请求: {:?}", cmd);
