...
use dex::cmd_handler::{
    OptionCommand, OptionKind, OptionPlaceOrderCmd, OptionSide, SubmitTradingCommandHandler,
    TradingCommand, TradingCommandEnvelope,
};
...
fn option_place_order_command_is_accepted_into_pending_queue() {
    ...
    let cmd = TradingCommandEnvelope {
        ...
        nonce: 1,
        timestamp_ns: 30_000,
        command: TradingCommand::Option(OptionCommand::PlaceOrder(OptionPlaceOrderCmd {
            trader_id: 99,
            underlying: "BTC".into(),
