...
impl<R: CmdRepo2, P: EventPublisher2> NewOrderCmdHandler<R, P> {
    pub fn new(repo: R, publisher: P) -> Self {
        Self { repo, publisher }
    }
}

impl<R: CmdRepo2, P: EventPublisher2> CmdHandlerInternal for NewOrderCmdHandler<R, P> {
...
impl<R: CmdRepo2, P: EventPublisher2> CmdHandlerForUpdate3 for NewOrderCmdHandler<R, P> {}
