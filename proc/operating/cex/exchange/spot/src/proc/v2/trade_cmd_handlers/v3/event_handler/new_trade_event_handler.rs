...
impl<R: CmdRepo2 + Clone, P: EventPublisher2 + Clone>
    EventHandler2<DomainEvent<SpotTrade>, SpotApiErrorAny> for NewTradeEventHandler<R, P>
{
    fn event_handle(&self, event: DomainEvent<SpotTrade>) -> Result<(), SpotApiErrorAny> {
