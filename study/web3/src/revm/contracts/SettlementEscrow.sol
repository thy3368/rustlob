...
contract SettlementEscrow {
    ...
    event SettlementReleased(bytes32 indexed settlementId, address indexed beneficiary, uint256 amount);
    ...
    function releaseSettlement(bytes32 settlementId) external {
        ...
        emit SettlementReleased(settlementId, settlement.beneficiary, settlement.amount);
    }
