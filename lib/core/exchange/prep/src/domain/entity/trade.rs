...
use super::types::{
    TradeId, OrderId, Price, Quantity, Side, PositionSide, Timestamp,
};
...
mod tests {
    ...
    fn test_notional_value() {
        let trade = Trade::new(
            1, 100, 50000, 10, Side::Buy, PositionSide::Long,
            1700000000000, 5, 0, true,
        );
    ...
    fn test_is_open_close() {
        ...
        let close_long = Trade::new(
            2, 101, 51000, 10, Side::Sell, PositionSide::Long,
            1700000000000, 5, 10000, false,
        );
        ...
        let open_short = Trade::new(
            3, 102, 50000, 10, Side::Sell, PositionSide::Short,
            1700000000000, 5, 0, true,
        );
