    ...
    B: BalanceRepository,
{
    ...
    /// 获取账户仓储的可变引用
    pub fn account_repo_mut(&mut self) -> &mut A {
        &mut self.account_repo
    }
    ...
    fn validate_command(&self, cmd: &AccountCommand) -> Result<(), BalanceError> {
        ...
        match cmd {
            AccountCommand::Transfer {
                ...
                // 检查源账户余额
                let balance = self.balance_repo.get(account_id, *asset_id).ok_or(
    ...
    fn execute(&mut self, cmd: AccountCommand) -> AccountCommandResult {
        ...
        match cmd {
            ...
            AccountCommand::GetBalance {
                ...
                self.balance_repo.get(account_id, asset_id).cloned(),
            ),
        }
    }
...
mod tests {
    ...
    fn create_test_service(
        ...
        service
            .balance_repo_mut()
            .set_balance(AccountId(1), AssetId::USDT, 10000);
        service
            .balance_repo_mut()
            .set_balance(AccountId(1), AssetId::BTC, 100);
    ...
    fn test_batch_execute() {
        ...
        service
            .balance_repo_mut()
            .set_balance(AccountId(2), AssetId::USDT, 5000);
