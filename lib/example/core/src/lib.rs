...
pub use entity::{
    ...
    HyperliquidPerpTrade, MarginReservation, MarketRules, Reservation, ReservationCloseReason,
    ...
    SpotConditionalOrderStatus, SpotOrder, SpotOrderExecution, SpotOrderFeeConsumeRequirement,
    ...
    SpotOrderV2MatchError, SpotTrade, SpotTradeFeeRole, compute_hourly_funding_rate_e8,
