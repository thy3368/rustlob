...
pub use entity::{
    ...
    HyperliquidPerpPositionTradeOutcome, HyperliquidPerpShortfall, HyperliquidPerpShortfallStatus,
    HyperliquidPerpTrade, MarginReservation, MarginSummary, MarketRules, MasterAccount,
    MatchSpotOrderV2Input, MatchSpotOrderV2Outcome, PerpAssetId, PerpClearinghouseState,
