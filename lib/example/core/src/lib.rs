...
pub use entity::{
    ...
    HyperliquidPerpShortfallStatus, HyperliquidPerpTrade, HyperliquidPerpTradePositionSettlement,
    MarginReservation, MarginSummary, MarketRules, MasterAccount, MatchSpotOrderV2Input,
    MatchSpotOrderV2Outcome, PerpAssetId, PerpClearinghouseState, PlaceHyperliquidPerpOrderInput,
    PlaceHyperliquidPerpOrderIntent, PlaceHyperliquidPerpOrderOutcome, PlaceSpotOrderV2Input,
