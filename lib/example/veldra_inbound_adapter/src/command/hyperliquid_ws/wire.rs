...
use crate::command::exchange::ExchangeActionRequestWire;
use crate::command::hyperliquid_ws::error::HyperliquidWsError;
    ...
    fn serializes_client_messages() {
        ...
        let action = serde_json::to_value(WsClientMessageWire::Post {
            ...
            request: Box::new(WsPostRequestWire::Action(Box::new(ExchangeActionRequestWire {
                action: crate::command::exchange::ExchangeActionWire::Noop,
                common: crate::command::exchange::CommonExchangeFields {
                    nonce: 1710000000000,
                    signature: crate::command::exchange::SignatureWire {
