use crate::command::hyperliquid_ws::AllMidsWire;
use crate::command::info::common::validate::{ensure_type, validate_non_empty_string_field};
use crate::command::info::error::InfoHttpError;
use crate::command::info::queries::InfoQueryDeps;

pub mod reply {
    pub type ResponseWire = crate::command::hyperliquid_ws::AllMidsWire;
}
