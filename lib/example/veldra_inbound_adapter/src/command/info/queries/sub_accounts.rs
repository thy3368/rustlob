use crate::command::hyperliquid_ws::{ClearinghouseStateWire, WsMarginSummaryWire};
use crate::command::info::common::validate::{ensure_type, validate_hex_address_field};
use crate::command::info::common::wire::{SpotBalanceWire, SpotStateWire, SubAccountWire};
use crate::command::info::error::InfoHttpError;
use crate::command::info::queries::InfoQueryDeps;

pub mod reply {
    pub type ResponseWire = Vec<crate::command::info::common::wire::SubAccountWire>;
}
