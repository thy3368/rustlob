...
use crate::command::info::common::wire::UserRoleResponseWire;
use crate::command::info::error::InfoHttpError;
use crate::command::info::queries::InfoQueryDeps;

pub mod reply {
    pub type ResponseWire = crate::command::info::common::wire::UserRoleResponseWire;
}
...
mod tests {
    ...
    use super::*;
    use crate::command::info::common::wire::UserRoleDataWire;
