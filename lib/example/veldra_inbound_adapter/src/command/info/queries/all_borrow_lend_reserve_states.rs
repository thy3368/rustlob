use crate::command::info::common::validate::ensure_type;
use crate::command::info::error::InfoHttpError;
use crate::command::info::queries::InfoQueryDeps;

pub mod reply {
    pub type ReserveStateWire =
        crate::command::info::queries::borrow_lend_reserve_state::reply::ResponseWire;
...
pub(crate) fn stub_response() -> reply::ResponseWire {
    vec![
        (0, crate::command::info::queries::borrow_lend_reserve_state::stub_response()),
        (
            150,
