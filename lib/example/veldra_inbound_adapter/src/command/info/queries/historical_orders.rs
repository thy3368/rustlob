...
use crate::command::info::common::wire::{FrontendOrderWire, OrderStatusEnvelopeWire};
use crate::command::info::error::InfoHttpError;
use crate::command::info::queries::InfoQueryDeps;

pub mod reply {
    pub type ResponseWire = Vec<crate::command::info::common::wire::OrderStatusEnvelopeWire>;
}
