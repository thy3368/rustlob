...
use crate::command::info::common::wire::InfoRequestTypeProbe;
use crate::command::info::error::InfoHttpError;
use crate::command::info::{InfoQueryDeps, InfoQueryReply, dispatch_info_query};
...
mod tests {
    ...
    use super::*;
    use crate::command::info::test_support::{
