...
use crate::command::exchange::common::wire::{ExchangeRequestEnvelopeWire, ok_status_response};
...
pub mod reply {
    ...
    use crate::command::exchange::common::wire::{ExchangeResponseWire, ExchangeStatusDataWire};
