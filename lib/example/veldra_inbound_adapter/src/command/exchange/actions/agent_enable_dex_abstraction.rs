...
pub mod reply {
    pub use crate::command::exchange::common::wire::ExchangeEmptyResponseWire as AgentEnableDexAbstractionResponseWire;
}
...
pub(crate) struct AgentEnableDexAbstractionAction;
