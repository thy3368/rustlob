...
use crate::command::exchange::common::validate::validate_common_fields;
...
pub mod reply {
    pub use crate::command::exchange::common::wire::ExchangeEmptyResponseWire as AgentSetAbstractionResponseWire;
}
...
mod tests {
    ...
    #[test]
    fn parses_request() {
        let request = parse_json_request::<AgentSetAbstractionRequestWire, ExchangeHttpError>(
            valid_request_json(),
        )
