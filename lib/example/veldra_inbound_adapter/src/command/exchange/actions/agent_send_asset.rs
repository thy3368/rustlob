...
use crate::command::exchange::common::validate::{validate_common_fields, validate_hex_address};
...
pub mod reply {
    pub use crate::command::exchange::common::wire::ExchangeEmptyResponseWire as AgentSendAssetResponseWire;
}
