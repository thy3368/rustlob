...
pub async fn handle(body: &[u8]) -> Result<reply::AgentSendAssetResponseWire, ExchangeHttpError> {
    run_exchange_action::<AgentSendAssetAction>(body).await
}
