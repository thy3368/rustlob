...
pub mod reply {
    pub use crate::exchange::common::wire::DefaultExchangeResponseWire as TokenDelegateResponseWire;
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
struct TokenDelegateRequestWire {
    action: TokenDelegateActionWire,
    #[serde(flatten)]
...
fn parse(body: &[u8]) -> Result<TokenDelegateRequestWire, ExchangeHttpError> {
