...
paths:
  /loans/interest:
    get:
      tags:
        - Loans
      summary: List interest summaries
      description: List summaries of interest owed by asset
      operationId: ExchangeRESTAPI_GetInterestSummary
      responses:
        '200':
          description: ''
          content:
            application/json:
              schema:
                type: array
                items:
                  $ref: '#/components/schemas/apiInterestSummary'
        '500':
  ...
  schemas:
    apiInterestSummary:
      ...
      properties:
        ...
        current_owed:
          type: string
          description: amount accrued in current month and not yet due
        last_payment_date:
          type: string
          format: date-time
        payment_status:
        ...
        last_payment_amount:
          type: string
        prior_period_overdue:
          type: string
          description: interest payable that accrued in previous months and is now due
        current_interest_due_date:
          type: string
          format: date-time
    apiErrorResponse:
      type: object
