...
````yaml GET /loans/loan-preview-xm
openapi: 3.0.1
info:
  title: REST API
  description: >-
...
paths:
  /loans/loan-preview-xm:
    get:
      tags:
        - Loans
      summary: Get loan preview XM
      description: Preview the results of a loan for a cross margin user.
      operationId: ExchangeRESTAPI_GetLoanPreviewXM
      parameters:
        - name: currency
          in: query
          required: true
