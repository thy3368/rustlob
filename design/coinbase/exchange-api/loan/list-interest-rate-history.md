...
````yaml GET /loans/interest/history/{loan_id}
openapi: 3.0.1
info:
  title: REST API
  description: >-
...
paths:
  /loans/interest/history/{loan_id}:
    get:
      tags:
        - Loans
      summary: List interest rate history
      description: List interest rate history for a loan
      operationId: ExchangeRESTAPI_GetInterestHistory
      parameters:
        - name: loan_id
          in: path
          required: true
          ...
          content:
            application/json:
              schema:
                type: array
                items:
                  $ref: '#/components/schemas/apiInterestRate'
        '500':
