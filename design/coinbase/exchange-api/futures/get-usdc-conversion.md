...
paths:
  /margin/usdc:
    get:
      tags:
        - Futures
      summary: Get USDC conversion
      description: >-
        Get the USDC to USD auto conversion setting to meet margin calls with
        eligible Coinbase Affiliate
      operationId: ExchangeRESTAPI_GetFcmUsdcMargin
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/apiGetFcmUsdcMarginResponse'
        '500':
