...
paths:
  /margin/auto-loan:
    post:
      ...
      description: >-
        Automatically initiate loans to meet margin calls with Coinbase
        affiliates in accordance with the Lending Agreement and Side Letter
      operationId: ExchangeRESTAPI_PostFcmAutoLoan
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/apiPostFcmAutoLoanRequest'
        required: true
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/apiPostFcmAutoLoanResponse'
        '500':
...
components:
  schemas:
    apiPostFcmAutoLoanRequest:
      type: object
      properties:
        auto_loan:
          type: boolean
    apiPostFcmAutoLoanResponse:
      type: object
      properties:
        auto_loan:
          type: boolean
