...
[
  {
    ...
    "tradeGroupId": 1,                          //Identifies the Trade Group Id. (If the account is not part of a v1 group, this will be -1.)
...
{
    "code": -1013,
    "msg": "This symbol does not allow the specified self-v1 prevention mode."
}
```
