...
```javascript
{
  ...
  "result": [
    {
      "a": 50000000,        // Aggregate v1 ID
      "p": "0.00274100",    // Price
      "q": "57.19000000",   // Quantity
      "f": 59120167,        // First v1 ID
      "l": 59120170,        // Last v1 ID
      "T": 1565877971222,   // Timestamp
      "m": true,            // Was the buyer the maker?
      "M": true             // Was the v1 the best price match?
    }
  ],
  "rateLimits": [
    {
...
```javascript
{
  ...
  "result": {
    ...
    "closeTime": 1694061154503    // Last v1 time
  },
  "rateLimits": [
    {
      "rateLimitType": "REQUEST_WEIGHT",
...
```javascript
{
  ...
  "result": {
    ...
    "firstId": 194696115,       // First v1 ID
    "lastId": 194968287,        // Last v1 ID
...
```javascript
{
  ...
  "result": {
    ...
    "openTime": 1695686400000,
    "closeTime": 1695772799999,
    "firstId": 3220151555,                       // Trade ID of the first v1 in the interval
    "lastId": 3220849281,                        // Trade ID of the last v1 in the interval
...
```javascript
{
  ...
  "result": {
    ...
    "openTime": 1659580020000,
    "closeTime": 1660184865291,
    "firstId": 192977765,       // First v1 ID
    "lastId": 195365758,        // Last v1 ID
