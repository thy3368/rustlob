...
use crate::proc::behavior::v2::spot_trade_behavior::{CancelOcoOrderCmd, OcoOrderInfo};
use crate::proc::behavior::v2::spot_trade_error::SpotApiErrorAny;

#[derive(Debug, Clone)]
pub struct CancelOcoOrderStateSet {
    pub order_list_id: u64,
}

pub struct CancelOcoOrderStateChangedSet {
...
impl DomainEventSet for CancelOcoOrderStateChangedSet {
    #[inline]
...
pub struct CancelOcoOrderCmdHandler;

impl CancelOcoOrderCmdHandler {
    pub fn new() -> Self {
        Self
    }
}

impl Default for CancelOcoOrderCmdHandler {
    fn default() -> Self {
        Self::new()
    }
}

impl CmdHandlerInternal for CancelOcoOrderCmdHandler {
    type Command = CancelOcoOrderCmd;
    type Reply = OcoOrderInfo;
    type GivenStateSet = CancelOcoOrderStateSet;
    type ThenStateSet = CancelOcoOrderStateChangedSet;
...
impl CmdHandlerForUpdate2 for CancelOcoOrderCmdHandler {}
