...
use crate::proc::behavior::v2::spot_trade_behavior::{CommissionRates, TestNewOrderCmd};
...
pub struct TestNewOrderStateChangedSet {
...
impl DomainEventSet for TestNewOrderStateChangedSet {
    #[inline]
...
pub struct TestNewOrderCmdHandler;

impl TestNewOrderCmdHandler {
    pub fn new() -> Self {
        Self
    }
}
...
impl CmdHandlerInternal for TestNewOrderCmdHandler {
    ...
    type GivenStateSet = TestNewOrderStateSet;
    type ThenStateSet = TestNewOrderStateChangedSet;
...
impl CmdHandlerForUpdate2 for TestNewOrderCmdHandler {}
