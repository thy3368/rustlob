...
use crate::proc::behavior::v2::spot_trade_behavior::{NewOtocoOrderCmd, OtocoOrderResult};
...
pub struct NewOtocoOrderStateChangedSet {
...
impl DomainEventSet for NewOtocoOrderStateChangedSet {
    #[inline]
...
pub struct NewOtocoOrderCmdHandler;

impl NewOtocoOrderCmdHandler {
    pub fn new() -> Self {
        Self
    }
}

impl Default for NewOtocoOrderCmdHandler {
    fn default() -> Self {
        Self::new()
    }
}
...
impl CmdHandlerInternal for NewOtocoOrderCmdHandler {
    ...
    type ThenStateSet = NewOtocoOrderStateChangedSet;
