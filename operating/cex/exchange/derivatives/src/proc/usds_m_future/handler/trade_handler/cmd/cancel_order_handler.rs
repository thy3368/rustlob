...
use crate::proc::usds_m_future::behavior::trade_behavior::{
    CancelOrderCmd, UsdsMFutureTradeCmdError,
};

pub struct CancelOrderCmdHandler<R: CmdRepo2, P: EventPublisher2> {
    pub repo: R,
    pub publisher: P,
}

impl<R: CmdRepo2, P: EventPublisher2> CancelOrderCmdHandler<R, P> {
    pub fn new(repo: R, publisher: P) -> Self {
        Self { repo, publisher }
    }
}

impl<R: CmdRepo2, P: EventPublisher2> CmdHandlerInternal for CancelOrderCmdHandler<R, P> {
...
impl<R: CmdRepo2, P: EventPublisher2> CmdHandlerForUpdate3 for CancelOrderCmdHandler<R, P> {}
